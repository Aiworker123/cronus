...
Data file: $CRONUS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CRONUS_HOME = Path(os.environ.get("CRONUS_HOME", Path.home() / ".cronus"))
DATA_DIR = _CRONUS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

...
DEFAULT_UA = (
    "cronus-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/cronus-agent; "
    "set CRONUS_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("CRONUS_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)

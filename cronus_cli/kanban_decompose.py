...
Invoked by ``cronus kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Cronus Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cronus_cli.kanban._profile_author``."""
    return (

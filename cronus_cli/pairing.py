...
Usage:
    cronus pairing list              # Show all pending + approved users
    cronus pairing approve <platform> <code>  # Approve a pairing code
    cronus pairing revoke <platform> <user_id> # Revoke user access
    cronus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cronus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cronus pairing {list|approve|revoke|clear-pending}")
        print("Run 'cronus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.cronus/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'cronus pairing list' to see pending codes.\n")

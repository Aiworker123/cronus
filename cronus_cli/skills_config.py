"""
Skills configuration for Cronus Agent.
`cronus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cronus/config.yaml under:
...
from cronus_cli.config import cfg_get, load_config, save_config
from cronus_cli.colors import Colors, color
from cronus_cli.platforms import PLATFORMS as _PLATFORMS

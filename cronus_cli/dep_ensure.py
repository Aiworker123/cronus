...
def _has_cronus_agent_browser() -> bool:
    ...
    # install.sh installs globally into $CRONUS_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-CronusHome", str(get_cronus_home()),
        ]
    else:

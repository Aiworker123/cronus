...
import type { ScrollBoxHandle } from '@cronus/ink'
import { evictInkCaches } from '@cronus/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CRONUS_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

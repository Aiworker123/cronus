 ...
 *
 * Symptom: in `cronus --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@cronus/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using cronus --tui and as i type multiline my caret at the end will often ' +

# Streaming LLM Response Support for Cronus Agent
...
```
CRONUS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CRONUS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `cronus_cli/config.py` | 1 | +streaming config defaults |

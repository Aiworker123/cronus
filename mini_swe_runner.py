#!/usr/bin/env python3
"""
SWE Runner with Cronus Trajectory Format

A runner that uses Cronus-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Cronus-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Cronus-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Cronus format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Cronus-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Cronus-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Cronus Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Cronus-Agent's built-in execution environments
    and outputs trajectories in Cronus-Agent format.
    """
    ...
    def _convert_to_cronus_format(
        ...
        """
        Convert internal message format to Cronus trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Cronus trajectory format
        trajectory = self._convert_to_cronus_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Cronus trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Cronus Trajectory Format")
    print("=" * 60)

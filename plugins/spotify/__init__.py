...
``_check_spotify_available()`` — when the user has not run ``cronus auth
spotify``, the tools remain registered (so they appear in ``cronus
...
The Spotify auth flow (``cronus auth spotify``), CLI plumbing, and docs

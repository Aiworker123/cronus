# Cronus Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.cronus/plugins/cronus-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.cronus/plugins/cronus-achievements/scan_checkpoint.json`.

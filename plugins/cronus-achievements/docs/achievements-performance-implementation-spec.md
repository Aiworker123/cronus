# Cronus Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.cronus/plugins/cronus-achievements/state.json` (existing unlock state)
  - `~/.cronus/plugins/cronus-achievements/scan_snapshot.json` (new)
  - `~/.cronus/plugins/cronus-achievements/scan_checkpoint.json` (new)

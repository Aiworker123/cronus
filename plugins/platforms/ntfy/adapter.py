"""ntfy platform adapter (Cronus plugin).
...
``plugins/platforms/ntfy/``. The Cronus plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "cronus-in"              # subscribe topic (incoming)
          publish_topic: "cronus-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``cronus cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Cronus dependency",

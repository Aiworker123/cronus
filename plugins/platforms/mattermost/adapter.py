...
required — uses aiohttp which is already a Cronus dependency.
...
def interactive_setup() -> None:
    ...
    ``cronus_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Cronus delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # cronus_cli/setup.py::_setup_mattermost function.

...
projection into Cronus' display, approval bridging, transcript projection into
...
"codex_app_server"`. Cronus' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("CRONUS_KANBAN_TASK"):
            kanban_db = spawn_env.get("CRONUS_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "CRONUS_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("CRONUS_HOME", os.path.expanduser("~/.cronus")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "cronus",
        client_title: str = "Cronus Agent",

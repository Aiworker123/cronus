...
(3 SDK retries x 3 Cronus retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_cronus_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".cronus")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Cronus, ...) behind one endpoint.  A 429 can mean either:

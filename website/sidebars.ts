...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-cronus-agent',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/software-development/software-development-cronus-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-cronus-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-cronus-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-cronus',
        'guides/use-soul-with-cronus',
        'guides/use-voice-mode-with-cronus',
        'guides/build-a-cronus-plugin',

...
Control the user's Spotify account via the Cronus Spotify toolset (7 tools). Setup guide: https://cronus-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `cronus auth spotify` again.

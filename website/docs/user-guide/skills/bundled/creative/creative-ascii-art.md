...
```bash
python3 -m pyfiglet "CRONUS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CRONUS&font=Slant" | boxes -d stone
```

...
```python
import sys
sys.path.insert(0, "/home/teknium/.cronus/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.cronus/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Cronus installs package this)

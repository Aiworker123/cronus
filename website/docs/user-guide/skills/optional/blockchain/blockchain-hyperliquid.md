...
| | |
|---|---|
| Source | Optional — install with `cronus skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Cronus Agent |
| License | MIT |
...
The script reads `~/.cronus/.env` for two optional defaults:
...
Helper script: `~/.cronus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.cronus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.cronus/.env`.
...
```bash
python3 ~/.cronus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.cronus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

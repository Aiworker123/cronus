...
| | |
|---|---|
| Source | Optional — install with `cronus skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Cronus Agent |
| License | MIT |
...
```
SCRIPT=~/.cronus/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cronus/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

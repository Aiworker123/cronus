...
| | |
|---|---|
| Source | Optional — install with `cronus skills install official/health/neuroskill-bci` |
...
Connect Cronus to a running [NeuroSkill](https://neuroskill.com/) instance to read

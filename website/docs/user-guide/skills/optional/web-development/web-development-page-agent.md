...
- User wants **Cronus itself to drive a browser** → use Cronus' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.

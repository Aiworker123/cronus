...
| | |
|---|---|
| Source | Optional — install with `cronus skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Cronus Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CRONUS_OSINT_CACHE/icij/ (default: ~/.cache/cronus-osint/icij/).
...
# Set CRONUS_OSINT_UA=your-app/1.0 (your@email) to identify yourself

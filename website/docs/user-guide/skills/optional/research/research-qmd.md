...
| | |
|---|---|
| Source | Optional — install with `cronus skills install official/research/qmd` |
...
Cronus Agent via the native MCP client. This is the preferred
...
Then configure Cronus Agent to connect via HTTP:

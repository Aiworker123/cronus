#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Cronus docs site.
...
Both publish at:
  https://cronus-agent.nousresearch.com/docs/llms.txt
  https://cronus-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://cronus-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Cronus as a Python Library", None),
        ("guides/use-mcp-with-cronus", "Use MCP with Cronus", None),
        ("guides/use-voice-mode-with-cronus", "Use Voice Mode with Cronus", None),
        ("guides/use-soul-with-cronus", "Use SOUL.md with Cronus", None),
        ("guides/build-a-cronus-plugin", "Build a Cronus Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Cronus"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "cronus-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/cronus-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Cronus Agent — Full Documentation\n",
        (
            "This file is the entire Cronus Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Cronus, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://cronus-agent.nousresearch.com/docs\n",
        "Short index: https://cronus-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

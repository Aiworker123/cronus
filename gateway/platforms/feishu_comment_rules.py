...
Config: ~/.cronus/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.cronus/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_cronus_home()`` helper (CRONUS_HOME-aware and
...
RULES_FILE = get_cronus_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_cronus_home() / "feishu_comment_pairing.json"

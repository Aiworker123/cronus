...
try:
    ...
    _CRONUS_VERSION = "0.0.0"

_APP_VERSION = _CRONUS_VERSION
_BOT_VERSION = _CRONUS_VERSION
_YUANBAO_INSTANCE_ID = str(CRONUS_INSTANCE_ID)  # single source: yuanbao_proto.CRONUS_INSTANCE_ID

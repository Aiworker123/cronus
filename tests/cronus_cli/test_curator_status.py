"""Tests for `cronus curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import cronus_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated CRONUS_HOME with real agent-created skills on disk."""
    ...
    from cronus_cli import curator as curator_cli

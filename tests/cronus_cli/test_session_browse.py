"""Tests for the interactive session browser (`cronus sessions browse`).
...
from cronus_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """cronus sessions browse should be parseable."""
        from cronus_cli.main import main as _main_entry

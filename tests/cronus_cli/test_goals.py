"""Tests for cronus_cli/goals.py — persistent cross-turn goals."""
...
def cronus_home(tmp_path, monkeypatch):
    """Isolated CRONUS_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves CRONUS_HOME.
    from cronus_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from cronus_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from cronus_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, cronus_home):
    ...
    def test_set_then_status(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_clear(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, cronus_home):
    ...
    def test_evaluate_after_turn_done(self, cronus_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, cronus_home):
        from cronus_cli import goals
        from cronus_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, cronus_home):
    ...
    def test_evaluate_after_turn_inactive(self, cronus_home):
    ...
    def test_continuation_prompt_shape(self, cronus_home):
        ...
        mgr.set("port goal command to cronus")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to cronus" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from cronus_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, cronus_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from cronus_cli import goals
        from cronus_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, cronus_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, cronus_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from cronus_cli import goals
        from cronus_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        import json
        from cronus_cli.goals import GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_add_subgoal_requires_active_goal(self, cronus_home):
        import pytest
        from cronus_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, cronus_home):
        import pytest
        from cronus_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, cronus_home):
        import pytest
        from cronus_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, cronus_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, cronus_home):
        from cronus_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, cronus_home):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, cronus_home):
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, cronus_home):
        from cronus_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, cronus_home):
        from cronus_cli.goals import GoalManager

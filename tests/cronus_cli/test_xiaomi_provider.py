...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from cronus_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CRONUS_OVERLAYS
        overlay = CRONUS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify cronus doctor recognizes Xiaomi env vars."""

...
def store(tmp_path, monkeypatch):
    ...
    ~/.cronus/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at cronus_state import time, before pytest's CRONUS_HOME monkeypatch
    fires — the autouse fixture's CRONUS_HOME override doesn't help here.)
    """
    import cronus_state

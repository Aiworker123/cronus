...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CRONUS_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CRONUS_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CRONUS_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path

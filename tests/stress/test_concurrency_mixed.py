...
def worker_loop(worker_id: int, cronus_home: str, result_file: str) -> None:
...
def reclaimer_loop(cronus_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="cronus_mixed_stress_")
    print(f"CRONUS_HOME = {home}")

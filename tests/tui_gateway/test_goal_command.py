...
def cronus_home(tmp_path, monkeypatch):
    ...
    # Bust the goal-module DB cache so it re-resolves CRONUS_HOME.
...
def test_slash_exec_rejects_goal_routes_to_command_dispatch(server, session):
    ...
    to command.dispatch. Without this, the CronusCLI slash-worker subprocess

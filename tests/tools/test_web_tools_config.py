...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_cronus_home_override(self, tmp_path):
        """Auth lookup should read from CRONUS_HOME/auth.json, not ~/.cronus/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".cronus").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``cronus tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """

...
DEFAULT_DATASETS = [
    ...
    "NousResearch/cronus-agent-megascience-sft1",
    "NousResearch/Cronus-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Cronus-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-cronus-agent"
]

#!/usr/bin/env python3
"""Build the Cronus Model Catalog — a centralized JSON manifest of curated models.
...
Cronus CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Cronus release.
...
# Ensure CRONUS_HOME is set for imports that touch it at module level.
os.environ.setdefault("CRONUS_HOME", os.path.join(os.path.expanduser("~"), ".cronus"))

from cronus_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "cronus-agent repo",
            "docs": "https://cronus-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {

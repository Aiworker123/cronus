#!/usr/bin/env python3
"""Build the Cronus Skills Index — a centralized JSON catalog of all skills.
...
`cronus skills search/install` can use it without hitting the GitHub API.
...
# Ensure CRONUS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Cronus Skills Index...", flush=True)

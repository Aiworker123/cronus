...
const SIDEBAR_COLLAPSED_KEY = "cronus-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="cronus-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="cronus-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateCronus,
      runningLabel: t.status.updatingCronus,
      spin: false,
    },
  ];

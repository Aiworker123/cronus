...
const STORAGE_KEY = "cronus-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `cronus_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "cronus-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-cronus-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-cronus-theme-font", "true");

...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateCronus: "Aggiorna Cronus",
    updatingCronus: "Aggiornamento di Cronus…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Cronus (parità con `cronus plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.cronus/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.cronus/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.cronus/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Cronus da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Cronus in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Cronus di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Cronus rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Cronus sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",

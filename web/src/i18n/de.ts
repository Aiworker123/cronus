...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateCronus: "Cronus aktualisieren",
    updatingCronus: "Cronus wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Cronus-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `cronus plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.cronus/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.cronus/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.cronus/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Cronus-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Cronus-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Cronus mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Cronus ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Cronus scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",

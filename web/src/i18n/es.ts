...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateCronus: "Actualizar Cronus",
    updatingCronus: "Actualizando Cronus…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Cronus (equivalente a `cronus plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.cronus/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.cronus/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.cronus/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de Cronus ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Cronus. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa Cronus más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Cronus detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Cronus está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",

...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateCronus: "Werk Cronus op",
    updatingCronus: "Besig om Cronus op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Cronus-inproppe op (`cronus plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.cronus/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.cronus/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.cronus/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Cronus-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Cronus-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Cronus meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Cronus 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Cronus skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",

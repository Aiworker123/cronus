 ...
 * `window.__CRONUS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Cronus brand in the top bar
 ...
 *  `window.__CRONUS_PLUGINS__.registerSlot(...)`.
 *

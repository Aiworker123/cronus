...
def auth_json_path():
    """Return the Cronus auth store path, respecting CRONUS_HOME overrides."""
    return get_cronus_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from cronus_cli.auth import resolve_nous_access_token

...
the get_anchored_view / get_messages_around primitives in cronus_state.
...
# Third-party integrations tag their sessions with CRONUS_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from cronus_state import DEFAULT_DB_PATH

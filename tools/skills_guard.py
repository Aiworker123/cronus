...
Trust levels:
  - builtin:   Ships with Cronus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.cronus/\.env|\~/\.cronus/\.env',
     "cronus_env_access", "critical", "exfiltration",
     "directly references Cronus secrets file"),
    ...
    (r'\.cronus/config\.yaml|\.cronus/SOUL\.md',
     "cronus_config_mod", "critical", "persistence",
     "references Cronus configuration files directly"),

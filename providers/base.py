...
def _profile_user_agent() -> str:
    """Return a ``cronus-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from cronus_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"cronus-cli/{_ver}"
    except Exception:
        return "cronus-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # cronus-cli UA so the catalog endpoint is reachable.

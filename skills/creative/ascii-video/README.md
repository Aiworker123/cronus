...
Built for [Cronus Agent](https://github.com/NousResearch/cronus-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/cronus-agent/skills/creative/ascii-video`](https://github.com/NousResearch/cronus-agent/tree/main/skills/creative/ascii-video) via PR.
